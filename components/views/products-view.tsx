  ...
  return <form onSubmit={submit}>
    ...
    {(id || imageUrls.length > 0) && <div className="form-layout"><div className="form-main">
      ...
      <section className="panel form-section"><header><span className="section-number">03</span><div><h2>店铺与合作信息</h2><p>这些字段可后续修改，商品链接变更会记录操作人和时间。</p></div></header><div className="form-grid">
        ...
        <Field label="商品链接" hint="支持完整网址、weixinstorehs/28512353738164 视频号链接或 v1= 推广参数。" className="field-full"><div className="input-prefix"><ExternalLink size={17} /><input type="text" inputMode="url" autoCapitalize="none" spellCheck={false} value={form.productUrl} onChange={(event) => set("productUrl", event.target.value)} placeholder="https://... 或 weixinstorehs/..." /></div></Field>
      </div></section>
