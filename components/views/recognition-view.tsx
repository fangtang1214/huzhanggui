...
type RecognitionData = {
  ...
  runs: Array<{ id: string; imageUrl: string; status: string; decision: string; error?: string; candidates: unknown[]; userName?: string; createdAt: string }>;
