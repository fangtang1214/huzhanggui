...
export function MovementsView() {
  ...
  return <>
    ...
    <section className="toolbar"><div className="search-box"><Search size={18} /><input value={search} onChange={(event) => { setSearch(event.target.value); setPage(1); }} placeholder="搜索实物编号、货号、商品、链接或操作人" /></div></section>
